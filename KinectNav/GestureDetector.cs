...
namespace KinectNav
{
    class GestureDetector : IDisposable
    {
        ...
        private string gestureDatabase = @"Database\test.gbd";

        /// <summary> Name of the discrete gesture in the database that we want to track </summary>
        private string GestureName = "CrossedHands";
                        ...
                        foreach (Gesture gesture in this.vgbFrameSource.Gestures)
                        {
                            if (gesture.Name.Equals(this.GestureName) && gesture.GestureType == GestureType.Discrete)
                            {
                                ...
                                if (result != null)
                                {
                                    ...
                                    this.GestureResultView.UpdateGestureResult(true, result.Detected, result.Confidence, GestureName);
                                }
                            }
                        }
                    }
